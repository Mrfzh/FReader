...
public class Constant {
    // 男生热门榜单的榜单数
    public static final int MALE_HOT_RANK_NUM = 6;
    // 男生热门榜单的 id
    ...
    private static String sQDHotRankId = "54d4306c321052167dfb75e4";    // 起点月票榜
    ...
    public static final List<String> MALE_HOT_RANK_ID = Arrays.asList(sZYHotRankId,
            sSQHotRankId, sQDHotRankId, sZHHotRankId, sZLHotRankId, sBDHotRankId);
    // 男生热门榜单的榜单名字
    public static final List<String> MALE_HOT_RANK_NAME = Arrays.asList("掌阅热销榜",
            "书旗热搜榜", "起点月票榜", "纵横月票榜", "逐浪点击榜", "百度热搜榜");
}
